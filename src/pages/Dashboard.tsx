...
import { IdeaOfTheWeek } from "@/components/dashboard/IdeaOfTheWeek";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Two Column Layout: Quick Actions + Activity Feed + Grant Recommendations */}
