...
const Settings = () => {
  ...
  const { getPreferences, savePreferences } = useNotifications();
  ...
  const [notificationPrefs, setNotificationPrefs] = useState(getPreferences());
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="welcomeEmail" className="text-base">Welcome Email</Label>
                  <p className="text-sm text-muted-foreground">
                ...
                <Switch
                  id="welcomeEmail"
                  checked={notificationPrefs.welcomeEmail}
                  onCheckedChange={(checked) => {
                    const updated = savePreferences({ welcomeEmail: checked });
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="ideaGenerated" className="text-base">Idea Notifications</Label>
                  <p className="text-sm text-muted-foreground">
                    Get notified when your business ideas are ready
                  </p>
                </div>
                <Switch
                  id="ideaGenerated"
                  checked={notificationPrefs.ideaGenerated}
                  onCheckedChange={(checked) => {
                    const updated = savePreferences({ ideaGenerated: checked });
                    setNotificationPrefs(updated);
                    toast.success("Preferences updated");
                  }}
                />
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="actionPlanReminders" className="text-base">Action Plan Reminders</Label>
                  <p className="text-sm text-muted-foreground">
                    Weekly reminders about your 30-60-90 day action plan progress
                  </p>
                </div>
                <Switch
                  id="actionPlanReminders"
                  checked={notificationPrefs.actionPlanReminders}
                  onCheckedChange={(checked) => {
                    const updated = savePreferences({ actionPlanReminders: checked });
                    setNotificationPrefs(updated);
                    toast.success("Preferences updated");
                  }}
                />
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="grantDeadlines" className="text-base">Grant Deadline Alerts</Label>
                  <p className="text-sm text-muted-foreground">
                    Be notified when grant application deadlines are approaching
                  </p>
                </div>
                <Switch
                  id="grantDeadlines"
                  checked={notificationPrefs.grantDeadlines}
                  onCheckedChange={(checked) => {
                    const updated = savePreferences({ grantDeadlines: checked });
                    setNotificationPrefs(updated);
                    toast.success("Preferences updated");
                  }}
                />
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive a weekly summary of your progress and new opportunities
                  </p>
                </div>
                <Switch
                  id="weeklyDigest"
                  ...
                  onCheckedChange={(checked) => {
                    const updated = savePreferences({ weeklyDigest: checked });
                    setNotificationPrefs(updated);
                    toast.success("Preferences updated");
                  }}
                />
